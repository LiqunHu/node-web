          ...
          <form @submit.prevent="addOp" id="formA">
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <select class="form-control select2" id="user_groups" data-parsley-required="true"></select>
              </div>
            </div>
    ...
    const initTable = () => {
      ...
      $table.bootstrapTable({
        ...
        columns: [
          ...
          common.BTRowFormatEdSelect2Multiple('user_groups', '用户组', _self.pagePara.groupInfo),
    ...
    const initPage = () => {
      _self.$http.post(apiUrl + 'init', {}).then(
        response => {
          ...
          common.initSelect2Multiple($('#user_groups'), retData.groupInfo)
          initTable()
          $('#formA').parsley()
  ...
  methods: {
    ...
    addOp: function(event) {
      ...
      if (
        ...
        _self.rowData.user_groups = $('#user_groups').val()
