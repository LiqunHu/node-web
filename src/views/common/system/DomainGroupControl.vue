        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">角色设置</h4>
                </div>
                <div class="panel-toolbar">
                    <div class="form-inline">
                        <div class="form-group">
                            <div class="form-group">
                                <button id="addFolder" class="btn btn-primary btn-info" v-on:click="addDep"><i class="glyphicon glyphicon-plus"></i> 增加权限组 </button>
                                <button id="addGroup" class="btn btn-primary btn-info" v-on:click="addPos"> <i class="glyphicon glyphicon-plus"></i> 增加角色 </button>
                                <button id="editNode" class="btn btn-primary btn-info" v-on:click="editNode"> <i class="glyphicon glyphicon-plus"></i> 编辑 </button>
                            </div>
